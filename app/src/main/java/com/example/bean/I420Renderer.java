...
/**
 * @class I420Renderer
 * 		This is a GLSurfaceView's renderer, which render the I420 image to the view.
 * 		Use native code to render Y,U,V, rest thing is done by the class.
 */

public class I420Renderer implements Renderer {
...
//		}
	...
	public I420Renderer(Context context, GLSurfaceView view,Handler handler) {
		context_ = context;
